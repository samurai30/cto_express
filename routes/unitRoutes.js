...
router.get('/',joiValidation.validateQueryData(unitSchema.getAllUnitSchema),tokenValidate.validateToken,checRoles.hasAccess(['store_manager','restaurant_admin','outlet_manager']),unitController.getAllUnit)
